module.exports = {
  params: {
    designator: 'PinHeader_1x02_Speaker',
    side: 'F',
    reversible: false,
    SPEAKER_POSITIVE: undefined,
    SPEAKER_NEGATIVE: undefined
  },
  body: p => {
    const standard = `
      ...
      ${'' /* fooptrint pinout */} 
      (pad "PLUS" thru_hole rect (at 0 0) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${p.SPEAKER_POSITIVE.str})
