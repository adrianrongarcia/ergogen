...
module.exports = {
    ...
    (module MX_optional_reversible (layer F.Cu)
        ...
        ${'' /* footprint reference */}
        (fp_text reference "${p.ref}" (at -1 -8.255) (layer "F.SilkS") ${p.ref_hide} (effects (font (size 0 1) (thickness 0.15)))
        ...
        (pad "1" thru_hole circle (at -3.81 -2.54) (size 2.286 2.286) (drill 1.4986) (layers "*.Cu" "*.Mask") ${p.from})
        (pad "1" thru_hole circle (at -3.81 2.54) (size 2.286 2.286) (drill 1.4986) (layers "*.Cu" "*.Mask") ${p.from})
        (pad "2" thru_hole circle (at 2.54 -5.08) (size 2.286 2.286) (drill 1.4986) (layers "*.Cu" "*.Mask") ${p.to})
        (pad "2" thru_hole circle (at 2.54 5.08) (size 2.286 2.286) (drill 1.4986) (layers "*.Cu" "*.Mask") ${p.to})
        
        ${'' /* hotwswap sockets net pads*/}
        (pad "1" smd rect (at -6.29 -5.08 ${p.r}) (size 2.55 2.5) (layers "F.Cu" "F.Paste" "F.Mask") ${p.from})
        (pad "1" smd rect (at -6.29 5.08 ${p.r}) (size 2.55 2.5) (layers "B.Cu" "B.Paste" "B.Mask") ${p.from})
        (pad "2" smd rect (at 7.56 -2.54 ${p.r}) (size 2.55 2.5) (layers "F.Cu" "F.Paste" "F.Mask") ${p.to})
        (pad "2" smd rect (at 7.56 2.54 ${p.r}) (size 2.55 2.5) (layers "B.Cu" "B.Paste" "B.Mask") ${p.to})
    )
