...
module.exports = {
  ...
  body: p => {
    ...
    function side_traces(side) {
      return `
          ${'' /* footprint outline */}
          (fp_line (start -12.125 5.217) (end -12.125 -5.217) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_line (start 9.622 -7.72) (end -9.622 -7.72) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_line (start 9.622 7.72) (end -9.622 7.72) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_line (start 12.125 5.217) (end 12.125 -5.217) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_arc (start -9.622 -5.217) (end -12.125 -5.217) (angle 90) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_arc (start -9.622 5.217) (end -9.622 7.72) (angle 90) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_arc (start 9.622 -5.217) (end 9.622 -7.72) (angle 90) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
          (fp_arc (start 9.622 5.217) (end 12.125 5.217) (angle 90) (stroke (width 0.1) (type default)) (layer ${side}.SilkS))
      
          ${'' /* footprint limits */}
          (fp_line (start -12.625 5.217) (end -12.625 -5.217) (stroke (width 0.05) (type solid)) (layer ${side}.CrtYd))
          (fp_line (start -9.622 -8.22) (end 9.622 -8.22) (stroke (width 0.05) (type solid)) (layer ${side}.CrtYd))
          (fp_line (start -9.622 8.22) (end 9.622 8.22) (stroke (width 0.05) (type solid)) (layer ${side}.CrtYd))
          (fp_line (start 12.625 5.217) (end 12.625 -5.217) (stroke (width 0.05) (type solid)) (layer ${side}.CrtYd))
          (fp_arc (start -9.622 -5.217) (end -9.622 -8.22) (angle -90) (stroke (width 0.05) (type default)) (layer ${side}.CrtYd))
          (fp_arc (start -9.622 5.217) (end -12.625 5.217) (angle -90) (stroke (width 0.05) (type default)) (layer ${side}.CrtYd))
          (fp_arc (start 9.622 -5.217) (end 12.625 -5.217) (angle -90) (stroke (width 0.05) (type default)) (layer ${side}.CrtYd))
          (fp_arc (start 9.622 5.217) (end 9.622 8.22) (angle -90) (stroke (width 0.05) (type default)) (layer ${side}.CrtYd))
        `
    }
    ...
    function legend(def_neg, def_pos, def_text_mirror, side) {
      return `
        ${''/* pin names */}
        (fp_text user SD (at -11.21 0 ${p.rot + 270}) (layer ${side}.SilkS) (effects (font (size 1.0795 1.0795) (thickness 0.1905)) ${def_text_mirror}))
        (fp_text user Gnd (at -11.14 ${def_pos}5.07 ${p.rot + 270}) (layer ${side}.SilkS) (effects (font (size 1.0795 1.0795) (thickness 0.1905)) ${def_text_mirror}))
        (fp_text user Vin (at -6.87 ${def_pos}2.54 ${p.rot + 270}) (layer ${side}.SilkS) (effects (font (size 0.8636 0.8636) (thickness 0.1524)) ${def_text_mirror}))
        (fp_text user "A+" (at -11.16 ${def_neg}5.087 ${p.rot + 270}) (layer ${side}.SilkS) (effects (font (size 1.0795 1.0795) (thickness 0.1905)) ${def_text_mirror}))
        (fp_text user "A-" (at -6.77 ${def_neg}2.5 ${p.rot + 270}) (layer ${side}.SilkS) (effects (font (size 1.0795 1.0795) (thickness 0.1905)) ${def_text_mirror}))
        (fp_text user "PAM8302A" (at -0.78 0 ${p.rot}) (layer ${side}.SilkS) (effects (font (size 1.0795 1.0795) (thickness 0.1905)) ${def_text_mirror}))
        `
    }
